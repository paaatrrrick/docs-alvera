...
This quickstart walks you through the fastest path from an empty repo to a live Mintlify docs site. In three steps, you set up a local preview environment, personalize your site with your own branding and content, and deploy your changes to the web. By the end, you have a working documentation site you can share and iterate on.
