...
This quickstart walks you through everything you need to publish a Mintlify site: cloning your docs repository, previewing it locally with the Mintlify CLI, making your first content edit, and pushing the change live. By the end, you'll have a working local development loop and a deployed site you can share.
