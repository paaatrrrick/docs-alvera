...
This quickstart walks you through setting up a Mintlify docs site end to end. You clone your docs repository, run the preview server locally with `mint dev`, and push your first change so it deploys to the web. Expect to finish in about 10 minutes, and have your GitHub account and Node.js 18+ ready before you begin.
