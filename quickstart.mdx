...
In this quickstart, you set up a local Mintlify environment, customize your docs site, and publish it to the web. Each step takes only a few minutes, and you finish with a live documentation site connected to your GitHub repository.

Before you start, make sure you have a Mintlify account and access to the GitHub repository created for you during onboarding.
