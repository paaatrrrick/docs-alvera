...
This quickstart walks you through everything you need to go from an empty repository to a live documentation site: setting up a local preview environment, making your first customization, and deploying your changes to the web. By the end, you'll have a working Mintlify site you can iterate on with confidence.
