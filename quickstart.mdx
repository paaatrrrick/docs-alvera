---
title: "Quickstart: launch your Mintlify docs site"
description: "Set up a local Mintlify environment, make your first customization, and deploy a new documentation site to the web in three quick steps."
---

## Get started in three steps

This quickstart walks you through the fastest path from an empty Mintlify project to a live documentation site. In about ten minutes, you set up a local preview environment, make your first content and styling changes, and deploy them to the web. You can then share a public URL with your team. No prior Mintlify experience is required—just a GitHub account and a working install of Git and Node.js.
