---
title: '⚙️ Global settings in docs.json'
description: 'Reference for every docs.json property that controls site name, theme, colors, logo, navigation, and integrations for your Mintlify docs.'
icon: 'gear'
---
