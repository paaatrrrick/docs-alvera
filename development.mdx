---
title: 'Local development with the Mint CLI'
description: 'Install the Mint CLI, run a local preview server with hot reload, and troubleshoot common issues when developing your Mintlify docs site.'
---
...
The Mint CLI lets you preview your documentation locally before publishing, with hot reload so changes appear instantly in your browser. Follow the steps below to install the CLI, start a local preview server, and resolve the errors you're most likely to hit along the way.
