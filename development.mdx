...
The Mint CLI runs your documentation site locally so you can preview changes with hot reload before pushing them to production. Follow the steps below to install the CLI and start a local preview server on macOS, Linux, or Windows.
