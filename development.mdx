...
The Mint CLI runs your documentation site locally with hot reload, so you can preview changes before pushing to production. Follow the steps below to install the CLI and start a preview server on macOS, Linux, or Windows.
